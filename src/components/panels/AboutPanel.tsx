...
export default function AboutPanel() {
  ...
  return (
    <section className="absolute inset-0 max-md:relative max-md:inset-auto flex items-center justify-center px-[6vw] bg-ink2 overflow-hidden max-md:py-0 max-md:mt-40 max-md:min-h-screen">
